...
export function attachCore(win = window) {
    const domRefs = {
        ...
        presampleFactorSelect: win.document.getElementById('presampleFactorSelect'),
        gridSizeSlider: win.document.getElementById('gridSizeSlider'),
        gridSizeValue: win.document.getElementById('gridSizeValue'),
        gridSizeHint: win.document.getElementById('gridSizeHint'),
        cellShapeSelect: win.document.getElementById('cellShapeSelect'),
        gridLineWidthSelect: win.document.getElementById('gridLineWidthSelect'),
        exportBackgroundSelect: win.document.getElementById('exportBackgroundSelect'),
